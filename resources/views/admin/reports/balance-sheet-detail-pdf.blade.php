                ...
                <th class="text-end">Amount (Tk)</th>
                        ...
                        @foreach ($assetData as $asset)
                            @php
                                ...
                                $showDetails = request('report_type') == 'detail' && $detailCount > 0;
                            ...
                            @if($hasMultipleAccounts)
                                <!-- Group Row with Multiple Individual Accounts -->
                                <tr>
                                ...
                                @foreach($assetDataDetailed[$asset['title']] as $detailAccount)
                                    <tr>
                                        <td class="text-start ps-5">&nbsp; &nbsp; &nbsp; &nbsp; └─ {{ $detailAccount['title'] }}
                                        ...
                                        <td class="text-end">{{ number_format($detailAccount['balance'], 2) }}</td>
                                    </tr>
                                @endforeach
                        ...
                        @foreach ($liabilityData as $liability)
                            ...
                            @if($hasMultipleAccounts)
                                ...
                                @endforeach
                            @elseif($hasSingleAccount)
                                <!-- Single Child Account - Show Only Child (No Parent) -->
                                @foreach($liabilityDataDetailed[$liability['title']] as $detailAccount)
                                    <tr>
                                        <td class="text-start ps-4">&nbsp; &nbsp; {{ $detailAccount['title'] }}
                                            @if($detailAccount['accountable_alias'] && $detailAccount['accountable_alias'] != 'Unknown')
                        ...
                        @foreach ($capitalData as $capital)
                            ...
                            @if($hasMultipleAccounts)
                                <!-- Parent Row with Multiple Children -->
                                <tr>
