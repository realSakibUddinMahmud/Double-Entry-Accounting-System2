        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <dl class="row mb-0">
                    ...
                    <dt class="col-sm-5">Received In:</dt>
                    <dd class="col-sm-7">
                        {{ $journal->debitTransaction->account->title ?? 'N/A' }}<br>
                        <small class="text-muted">
                            {{ $journal->debitTransaction->account->accountable_alias ?? '-' }} -
...
<div class="modal fade" id="delete-journal-{{ $journal->id }}" tabindex="-1" aria-labelledby="deleteJournalLabel{{ $journal->id }}" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content p-5">
            <form action="{{ route('sales.payments.destroy', [$sale->id, $journal->id]) }}" method="POST">
                @csrf
                @method('DELETE')
