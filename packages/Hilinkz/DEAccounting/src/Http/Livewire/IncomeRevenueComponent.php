...
class IncomeRevenueComponent extends Component
{
    use WithFileUploads;
    use UsesTenantConnection;

    public $sourceAccountRootType = 4;  //Income
    public $destinationAccountRootType = 1; //Assets
    public $eventName = 'INCOME-REVENUE';
    ...
    public function render()
    {
        ...
        return view('de-accounting::livewire.income-revenue.create');
    }
