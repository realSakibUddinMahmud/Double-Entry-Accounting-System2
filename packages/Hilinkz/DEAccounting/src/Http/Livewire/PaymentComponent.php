...
class PaymentComponent extends Component
{
    ...
    public $sourceAccountRootType = 1; //Assets
    public $destinationAccountRootType = 3; //Liabilities
    public $eventName = 'PAYMENT';
    ...
    public function render()
    {
        ...
        return view('de-accounting::livewire.payment.create');
    }
