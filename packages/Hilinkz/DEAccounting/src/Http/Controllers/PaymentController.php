...
{
    public static $eventName = 'PAYMENT';
    public function index()
    {
        ...
        if (request()->filled('download') && request('download') === 'YES') {
            ...
            $pdfFileName = 'Payment-Report-' . $start_date . '-' . $end_date . '-' . uniqid().'-'.env('APP_NAME');
            $pdf = PDF::setPaper('a4', 'portrait')
                ->loadView('de-accounting::payments.download-pdf', [
                    'journals' => $journals,
        ...
        return view('de-accounting::payments.index', compact('journals'));
    }
    ...
    {
        return view('de-accounting::payments.create');
    }
