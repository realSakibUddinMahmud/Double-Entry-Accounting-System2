{{-- filepath: /opt/lampp/htdocs/ryogas/hilinkz-inventory/packages/Hilinkz/DEAccounting/resources/views/livewire/loan-invreturn/create.blade.php --}}
<form wire:submit.prevent="store">
    ...
    <div class="row g-3">
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    <h5>To <small class="text-muted">(Liabilities)</small></h5>
                </div>
                <div class="card-body">
                    <div class="row g-3">
                        <div class="col-md-8">
