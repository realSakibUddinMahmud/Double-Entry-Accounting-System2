...
<div class="modal fade" id="add-tax">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="<?php echo e(route('taxes.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<!-- /Add Tax Modal --><?php /**PATH /workspace/Double-Entry-Accounting-System/resources/views/admin/tax/create-modal.blade.php ENDPATH**/ ?>