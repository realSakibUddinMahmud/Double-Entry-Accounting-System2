<?php $__env->startSection('title', 'Income/Revenue'); ?>
...
<div class="page-header">
    <div class="add-item d-flex">
        <div class="page-title">
            ...
            <h6>Manage your income and revenue transactions</h6>
        </div>
    </div>
    <div class="page-btn">
        <a href="<?php echo e(route('de-income-revenue.create')); ?>" class="btn btn-primary">
            <i class="ti ti-circle-plus me-1"></i>New Income/Revenue
        </a>
    </div>
</div>
...
$__html = app('livewire')->mount($__name, $__params, 'lw-3526923439-0', $__slots ?? [], get_defined_vars());
...
<div class="card">
    <div class="card-header d-flex align-items-center justify-content-between flex-wrap row-gap-3">
        <h5 class="card-title mb-0">Income Revenue List</h5>
        <div class="ms-auto">
            <span class="text-muted">Total: <?php echo e($journals->total()); ?> revenues</span>
        </div>
    </div>
                    ...
                    <?php $__currentLoopData = $journals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $journal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td class="text-right">
                                ...
                                <?php endif; ?>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('de-income-revenue-delete')): ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.pagination','data' => ['paginator' => $journals,'infoText' => 'revenues']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['paginator' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($journals),'info-text' => 'revenues']); ?>
...
<?php echo $__env->make('de-accounting::income-revenues.delete-modal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php echo $__env->make('de-accounting::income-revenues.files-modal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php $__env->stopSection(); ?>


<?php echo $__env->make('layouts.app-admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /workspace/Double-Entry-Accounting-System/packages/Hilinkz/DEAccounting/src/../resources/views/income-revenues/index.blade.php ENDPATH**/ ?>