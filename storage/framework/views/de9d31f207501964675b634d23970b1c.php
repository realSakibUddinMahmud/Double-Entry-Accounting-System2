<?php $__env->startSection('title', 'Fund Transfers'); ?>
...
<div class="page-header">
    ...
    <div class="page-btn">
        <a href="<?php echo e(route('de-fund-transfer.create')); ?>" class="btn btn-primary">
...
$__html = app('livewire')->mount($__name, $__params, 'lw-3836026793-0', $__slots ?? [], get_defined_vars());
...
<div class="card">
    <div class="card-header d-flex align-items-center justify-content-between flex-wrap row-gap-3">
        ...
        <div class="ms-auto">
            <span class="text-muted">Total: <?php echo e($journals->total()); ?> transfers</span>
        </div>
    </div>
                    ...
                    <?php $__currentLoopData = $journals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $journal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td class="text-right">
                                ...
                                <?php endif; ?>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('de-fund-transfer-delete')): ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.pagination','data' => ['paginator' => $journals,'infoText' => 'transfers']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['paginator' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($journals),'info-text' => 'transfers']); ?>
...
<?php echo $__env->make('de-accounting::fund-transfers.delete-modal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php echo $__env->make('de-accounting::fund-transfers.files-modal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php $__env->stopSection(); ?>


<?php echo $__env->make('layouts.app-admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /workspace/Double-Entry-Accounting-System/packages/Hilinkz/DEAccounting/src/../resources/views/fund-transfers/index.blade.php ENDPATH**/ ?>