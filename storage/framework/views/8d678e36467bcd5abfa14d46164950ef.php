...
<?php $__env->startSection('content'); ?>
        ...
        <div class="card">
            <div class="card-body pb-1">
                <form action="<?php echo e(route('report.purchase')); ?>" method="GET">
                        ...
                        <div class="col-lg-2">
                            <div class="mb-3 d-flex gap-2">
                                ...
                                <a class="btn btn-secondary w-100"
                                   href="<?php echo e(route('report.purchase.export', array_merge(request()->all(), ['format' => 'pdf']))); ?>">
                                    PDF
                                </a>
                            </div>
                        </div>
                            ...
                            <?php $__currentLoopData = $reportRows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $storeName => $products): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo e($row['purchased_qty']); ?></td>
                                        <td><?php echo e(number_format($row['purchased_amount'], 2)); ?></td>
                                    </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.app-admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /workspace/resources/views/admin/reports/purchase.blade.php ENDPATH**/ ?>