        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    <h5>From <small class="text-muted">(Income)</small></h5>
                </div>
                <div class="card-body">
                    <div class="row g-3">
                        <div class="col-md-8">
                                    ...
                                    <!--[if BLOCK]><![endif]--><?php if(!empty($sourceAccounts)): ?>
                                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $sourceAccounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sourceAccount): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($sourceAccount->id); ?>">
                                                <?php echo e($sourceAccount->title); ?>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control"
                                    wire:model="source_amount" required placeholder="Amount"
                                    pattern="^\d*(\.\d{0,2})?$"
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="form-label">Amount</label>
                                <input type="text" class="form-control"
                                    wire:model="destination_amount" required placeholder="Amount"
...
</script><?php /**PATH /workspace/packages/Hilinkz/DEAccounting/src/../resources/views/livewire/income-revenue/create.blade.php ENDPATH**/ ?>