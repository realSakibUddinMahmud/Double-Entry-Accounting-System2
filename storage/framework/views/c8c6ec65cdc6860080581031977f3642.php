                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <select class="form-control"
                                    ...
                                    <option value="">Select an option</option>
                                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $destination_accountable_data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $destination_accountable_data_item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($destination_accountable_data_item->id); ?>">
                                            <?php echo e($destination_accountable_data_item->name ?? $destination_accountable_data_item->title); ?>
...
</script><?php /**PATH /workspace/packages/Hilinkz/DEAccounting/src/../resources/views/livewire/fund-transfer/create.blade.php ENDPATH**/ ?>