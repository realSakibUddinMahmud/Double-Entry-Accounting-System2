...
<div class="card">
    ...
    <div class="card-body">
        <form method="GET" action="<?php echo e(route('purchases.index')); ?>" class="row g-3">
            <div class="col-md-3">
            ...
            <div class="col-md-2">
                ...
                <select name="payment_status" class="form-select">
                    ...
                    <option value="Partial" <?php echo e(request('payment_status')=='Partial' ? 'selected' : ''); ?>>Partial
                    </option>
...
<div class="card">
    <div class="card-header d-flex align-items-center justify-content-between flex-wrap row-gap-3">
        ...
        <div class="ms-auto">
            <span class="text-muted">Total: <?php echo e($purchases->total()); ?> purchases</span>
        </div>
    </div>
            ...
            <table class="table table-hover table-sm">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            <label class="checkboxs">
                                <input type="checkbox" value="<?php echo e($purchase->id); ?>">
                                <span class="checkmarks"></span>
                            </label>
                        </td>
                        <td><?php echo e($purchase->u_id ?? $purchase->id); ?></td>
                        <td><?php echo e(\Carbon\Carbon::parse($purchase->purchase_date)->format('d/m/Y')); ?></td>
                        <td><?php echo e(optional($purchase->supplier)->name ?? '-'); ?></td>
                        <td><?php echo e(optional($purchase->store)->name ?? '-'); ?></td>
                        ...
                        <td class="action-table-data">
                            <div class="edit-delete-action d-flex align-items-center">
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('purchase-show')): ?>
                                <a class="me-2 p-2" href="<?php echo e(route('purchases.show', $purchase->id)); ?>"
                                    title="View Invoice">
                                    <i class="ti ti-file-invoice"></i>
                                </a>
                                <?php endif; ?>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('purchase-edit')): ?>
                                <a class="me-2 p-2" href="<?php echo e(route('purchases.edit', $purchase->id)); ?>">
                                    <i data-feather="edit" class="feather-edit"></i>
                                </a>
                                <?php endif; ?>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('purchase-payment-view')): ?>
                                <a class="me-2 p-2" href="<?php echo e(route('purchases.payments', $purchase->id)); ?>"
                                    title="Payments">
                                    <i class="ti ti-currency-dollar"></i>
                                </a>
                                <?php endif; ?>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('purchase-delete')): ?>
                                <a class="p-2" href="javascript:void(0);" data-bs-toggle="modal"
                                    data-bs-target="#deletePurchaseModal" data-id="<?php echo e($purchase->id); ?>">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.pagination','data' => ['paginator' => $purchases,'infoText' => 'purchases']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['paginator' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($purchases),'info-text' => 'purchases']); ?>
...
<?php echo $__env->make('admin.purchase.delete-modal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        if (deleteModal) {
            deleteModal.addEventListener('show.bs.modal', function (event) {
                ...
                document.getElementById('deletePurchaseForm').action = "<?php echo e(url('purchases')); ?>/" + id;
            });
        }
    });
</script>
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app-admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /workspace/Double-Entry-Accounting-System/resources/views/admin/purchase/index.blade.php ENDPATH**/ ?>