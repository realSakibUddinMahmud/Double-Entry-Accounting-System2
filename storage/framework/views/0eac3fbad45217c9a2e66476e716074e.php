        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="text-center mb-3">
                    <img id="view_brand_logo" src="<?php echo e(asset('admin/no-image.png')); ?>" alt="Logo" style="height:200px; width:200px; object-fit:cover; border-radius:50%;">
...
<!-- /View Brand Modal --><?php /**PATH /workspace/Double-Entry-Accounting-System/resources/views/admin/brand/view-modal.blade.php ENDPATH**/ ?>