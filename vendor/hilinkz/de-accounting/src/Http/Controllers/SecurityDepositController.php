...
{
    public static $eventName = 'SECURITY-DEPOSIT';
    public function index()
    {
        ...
        if (request()->filled('download') && request('download') === 'YES') {
            ...
            $pdf = PDF::setPaper('a4', 'portrait')
                ->loadView('de-accounting::security-deposits.download-pdf', [
                    'journals' => $journals,
        ...
        return view('de-accounting::security-deposits.index', compact('journals'));
    }
    ...
    {
        return view('de-accounting::security-deposits.create');
    }
    ...
    public function delete($id)
    {
        ...
        if ($journal) {
            ...
            if ($result['status'] && $result['status'] == true) {
                return redirect()->back()->with('success', 'Security deposit deleted successfully.');
            } 
        }

        return redirect()->back()->with('error', 'Failed to delete security deposit.');
    }
