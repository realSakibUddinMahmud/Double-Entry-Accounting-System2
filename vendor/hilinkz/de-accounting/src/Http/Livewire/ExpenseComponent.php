...
class ExpenseComponent extends Component
{
    ...
    public $destinationAccountRootType = 2;
    public $eventName = 'EXPENSE';
    ...
    public function render()
    {
        ...
        return view('de-accounting::livewire.expense.create');
    }
    ...
    public function store()
    {
        ...
        $requestedData['destination_accountable_id'] = $this->source_accountable_id;
        $requestedData['source_accountable_type'] = $this->source_accountable_type;
        $requestedData['destination_accountable_type'] = $this->source_accountable_type;
