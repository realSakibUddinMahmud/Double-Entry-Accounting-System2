{{-- filepath: /opt/lampp/htdocs/ryogas/hilinkz-inventory/packages/Hilinkz/DEAccounting/resources/views/expenses/index.blade.php --}}
...
<div class="page-header">
    ...
    <div class="page-btn">
        <a href="{{ route('de-expense.create') }}" class="btn btn-primary">
...
<div class="card">
    <div class="card-header d-flex align-items-center justify-content-between flex-wrap row-gap-3">
        ...
        <div class="ms-auto">
            <span class="text-muted">Total: {{ $journals->total() }} expenses</span>
        </div>
    </div>
    <div class="card-body p-0">
        ...
        <!-- Pagination -->
        <x-admin.pagination :paginator="$journals" info-text="expenses" />
    </div>
</div>
