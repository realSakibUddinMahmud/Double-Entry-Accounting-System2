...
<div class="page-header">
    ...
    <div class="page-btn">
        <a href="{{ route('de-income-revenue.create') }}" class="btn btn-primary">
...
<div class="card">
    <div class="card-header d-flex align-items-center justify-content-between flex-wrap row-gap-3">
        ...
        <div class="ms-auto">
            <span class="text-muted">Total: {{ $journals->total() }} revenues</span>
        </div>
    </div>
    <div class="card-body p-0">
        ...
        <!-- Pagination -->
        <x-admin.pagination :paginator="$journals" info-text="revenues" />
    </div>
</div>

@include('de-accounting::income-revenues.delete-modal')
@include('de-accounting::income-revenues.files-modal')
@endsection
