                ...
                <table border="0">
                    ...
                    @php
                        ...
                        if ($accountStatement != null) {
                            $balance_amount = $accountStatement->prev_balance ?? 0;
                            $total_credit_amount = $accountStatement->prev_balance ?? 0;
                            $carry_balance = $accountStatement->prev_balance ?? 0;
                        } else {
                            $balance_amount = 0;
                    ...
                    <tr class="bg-2 bold">
                        ...
                        <td></td>
                        <td></td>
                        <td style="text-align: right; "><b>{{ number_format($total_debit_amount,2) }}</b></td>
                        <td style="text-align: right; "><b>{{ number_format($total_credit_amount-$carry_balance,2) }}</b></td>
                        <td style="text-align: right; "><b>{{ number_format($balance_amount ?? 0,2) }} @if ($balance_amount < 0)
                                Cr
                            @else
                                Dr
                            @endif
