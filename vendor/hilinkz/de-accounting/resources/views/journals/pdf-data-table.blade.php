<style>
    ...
    th:nth-child(2), td:nth-child(2) { width: 15%; } /* Reference */
    th:nth-child(3), td:nth-child(3) { width: 33%; } /* Account Title - More space */
    th:nth-child(4), td:nth-child(4) { width: 20%; } /* Note - Reduced space */
    th:nth-child(5), td:nth-child(5) { width: 10%; } /* Debit */
    th:nth-child(6), td:nth-child(6) { width: 10%; } /* Credit */
</style>
        ...
        @forelse($journals as $index => $journal)
            ...
            <tr>
                ...
                @if ($last_debit_transaction_id != $journal->debit_transaction_id)
                    <td style="border-bottom: none; text-align:left; position: relative;">
                        {{ $journal->debitTransaction->account->title ?? 'AC Missing' }}
                        <span style="position: absolute; right: 4px;">(Dr.)</span><br>
                        {{ $journal->creditTransaction->account->title ?? null }}
                        <span style="position: absolute; right: 4px;">(Cr.)</span>
                    </td>
                ...
                @else
                    <td style="border-top:none; border-bottom: none; text-align:left; position: relative;">
                        {{ $journal->creditTransaction->account->title ?? null }}
                        <span style="position: absolute; right: 4px;">(Cr.)</span>
                    </td>
                    <td style="border-top:none; border-bottom: none;"></td>
