{{-- filepath: /opt/lampp/htdocs/ryogas/hilinkz-inventory/packages/Hilinkz/DEAccounting/resources/views/livewire/account/update.blade.php --}}
    ...
    <div class="card">
        <div class="card-body row g-3">
            ...
            <div class="col-12 text-end">
                ...
                <a href="{{ route('de-account.index') }}" class="btn btn-secondary">Cancel</a>
            </div>
        </div>
    </div>
</form>